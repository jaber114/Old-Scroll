...
<head>
    ...
    <title>Hebrew Digital Books</title>
            ...
            <div class="col">
                <div class="bbb_main_container">
                    <div class="bbb_viewed_title_container">
                        <center>
                        <h3 class="bbb_viewed_title">ספרים מתורגמות</h3>
                       </center> 
                    ...
                    <div class="bbb_viewed_slider_container">
                        ...
                        <?php 
                             $query = "SELECT * FROM books  Where book_cat='Hebrew Translate Books'";
        ...
        <div class="row">
            <div class="col">
                <div class="bbb_main_container">
                    <div class="bbb_viewed_title_container">
                        <center>
                        <h3 class="bbb_viewed_title">ספרי רומנטיקה</h3>
                       </center> 
                        <div class="bbb_viewed_nav_container">
                            <div class="bbb_viewed_nav bbb_viewed_prev"><i class="fas fa-chevron-left"></i></div>
                            <div class="bbb_viewed_nav bbb_viewed_next"><i class="fas fa-chevron-right"></i></div>
                    ...
                    <div class="bbb_viewed_slider_container">
                        <div class="owl-carousel owl-theme bbb_viewed_slider">
                        <?php  
                             $query = "SELECT * FROM books  Where book_cat='Hebrew Digital Romantic Books'" ;
                              $result = mysqli_query($con,$query);
                              if(mysqli_num_rows($result) > 0)
                                  {
                                while ($row = mysqli_fetch_array($result))
